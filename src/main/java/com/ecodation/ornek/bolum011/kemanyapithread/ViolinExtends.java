...
public class ViolinExtends extends Thread implements Serializable {
	...
	public ViolinExtends() {
	}

	public ViolinExtends(String threadAdi) {
		this.threadAdi = threadAdi;
	}

	public ViolinExtends(long id, String yay, String onPanel, String yanPanel, String arkaPanel, String kopru,
			String diger) {
		super();
		this.id44 = id;
		this.yay = yay;
