...
public class ViolinImplements extends YayliCalgilar implements Serializable, Runnable {
	...
	public ViolinImplements() {
	}

	public ViolinImplements(String threadAdi) {
		this.threadAdi = threadAdi;
	}

	public ViolinImplements(long id, String yay, String onPanel, String yanPanel, String arkaPanel, String kopru,
			String diger) {
		super();
		this.id44 = id;
		this.yay = yay;
